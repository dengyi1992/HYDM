...
;dwfis.define("common", function (i, e, o) {
    ...
    function n(i) {
        ...
        if (/android/i.test(s)) {
            ...
            if (u.isIos9)return location.href = "https://secstatic.yy.com/huya/?sid=" + d + "&subsid=" + a + "&screenType=" + r + "&liveSourceType=" + c, void(u.isIpWx && setTimeout(function () {
...
;dwfis.define("chatlive", function (o, t, n) {
    function s() {
        this.init()
    }
    ...
    i.prototype = {
        init: function (o) {
            var t = this, n = t._option;
            console.log(n), t.$chatOuter = $("#chatArea"), t.$chatMask = $(".chat_mask"), t.common = o;
            var i = document.documentElement.clientHeight - 50 - $(".video0").height() - 45;
            t.$chatOuter.css("height", i), t.$chatMask.css("height", i - 45), $(".chat_banner").show(), t.tanmu = new s, t.bindEvent(), t.broadcast(n)
        }, bindEvent: function () {
            var o = this;
            ...
            }), $(".chat_pop_close").on("touchstart", function (t) {
                t.stopPropagation(), $(".chat_pop").attr("class", "chat_pop").hide(), $(".anchor_info_mask").hide(), o.$chatMask.hide()
            }), $(".chat_pop").on("touchstart", function () {
                o.common.downLoadApp()
            }), $(".chat_show_pop_speak").on("touchstart", function () {
                o.showPop("chat_pop_speak", "\u4e0e\u89c2\u4f17\u4e00\u8d77\u5237\u7206\u5f39\u5e55\uff01")
            }), $(".chat_show_pop_gift").on("touchstart", function () {
                o.showPop("chat_pop_gift", "\u9001\u793c\u7ed9\u4e3b\u64ad\uff0c\u5f70\u663e\u4f60\u9738\u6c14\uff01")
            }), $(".chat_pop_open")[0].addEventListener("touchstart", function (t) {
                t.stopPropagation(), o.common.downLoadApp()
            }), $(".chat_btn")[0].addEventListener("touchstart", function () {
                o.common.downLoadApp()
            })
        }, showPop: function (o, t, n) {
            var s = this;
            s.$chatMask.show(), "1" == n ? $(".chat_pop").addClass(o).show() : ($(".chat_pop").attr("class", "chat_pop").hide(), $(".anchor_info_mask").hide(), $(".chat_pop").eq(0).addClass(o).show(), $(".chat_pop").eq(1).hide()), $(".chat_pop_txt").html(t), s.common.downLoadApp()
        }, broadcast: function (o) {
            function t() {
                var o = new HUYA.LiveLaunchReq;
                o.tId = a, o.tLiveUB.eSource = HUYA.ELiveSource.WEB_HUYA, e.sendWup("liveui", "doLaunch", o)
            }

            function n() {
                var o = new HUYA.WSUserInfo;
                o.lUid = G.yyuid, o.bAnonymous = 0 == G.yyuid, o.sGuid = a.sGuid, o.sToken = "", o.lTid = G.topsid, o.lSid = G.subsid, o.lGroupId = 0, o.lGroupType = 0, e.sendRegister(o)
            }

            function s() {
                var o = new HUYA.UserChannelReq;
                o.tId = a, o.lTopcid = G.topsid, o.lSubcid = G.subsid, o.sSendContent = "", console.log("\u8ba2\u9605\u9891\u9053\uff1a", G.topsid, G.subsid), e.sendWup("liveui", "userIn", o)
            }

            function i() {
                var o = new HUYA.GetPropsListReq;
                o.tUserId = a, o.sMd5 = "", o.iTemplateType = HUYA.EClientTemplateType.TPL_PC, o.sVersion = "", console.log("send_init"), e.sendWup("PropsUIServer", "getPropsList", o)
            }

            G = o;
            var e = new TafHandler, a = new HUYA.UserId, c = this;
            e.addListener("WEBSOCKET_CONNECTED", function () {
                a.lUid = G.yyuid, a.sGuid = "", a.sToken = "", a.sHuYaUA = "webh5&1.0.0&websocket", a.sCookie = document.cookie, t(), i()
            }), e.addListener("sGuid", function (o) {
                a.sGuid = o.sGuid, n(), s()
            }), e.addListener("WSRegisterRsp", function () {
            }), e.addListener("userIn", function (o) {
                console.log("<<< \u6210\u529f\u8fdb\u5165\u9891\u9053 ", o)
            }), e.addListener("1003", function (o) {
                var t = {type: 0, nick: o.tSender.sSenderNick, msg: o.sMsg};
                c.tanmu.receive(t)
            }), e.addListener("6501", function (o) {
                console.log("6501", o);
                var t = o.iItemType.toString(), n = {
                    type: 1,
                    nick: o.sSenderNick,
                ...
                c.tanmu.receive(n)
            }), e.addListener("6502", function (o) {
                console.log("6502", o)
            }), e.addListener("getPropsList", function (o) {
                console.log("daoju-", o);
                var t = o.vPropsItemList.value;
                $.each(t, function (o, t) {
        ...
        init: function () {
            ...
            var t = this, n = "";
            0 == o.type ? n = '<li class="normal"><span class="nick">' + o.nick + '</span><span class="fuhao">\uff1a</span> ' + o.msg + "</li>" : 1 == o.type && (n = '<li class="prop"><span class="nick">' + o.nick + '</span> \u9001\u51fa <img  src="' + o.icon + '"/> <span class="nick">' + o.count + "</span></li>"), t.appendList(n)
        }, appendList: function (o) {
            var t = this;
            t.blankHtml += o, t.msgCount++, t.timer || (t.timer = setTimeout(function () {
                t.tanmuUl.append(t.blankHtml), t.timer = null, t.blankHtml = "", t.msgCount >= 100 && (t.tanmuUl.find("li").slice(0, 50).remove(), t.msgCount = t.msgCount - 50, t.isGotoBottom = !0), t.tanmuScroll.refresh(), t.isGotoBottom && t.tanmuScroll.scrollTo(0, t.tanmuScroll.maxScrollY, 0, null)
            }, 100))
